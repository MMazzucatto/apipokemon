    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={styles.topo}>
          <Text style={styles.topoTitulo}>POKEMON DO CAUÃ E DO MURILO</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  topo: { height: 80, padding: 30, paddingTop: 10, marginBottom: 0, backgroundColor: '#e73e33' },
  topoTitulo: { fontSize: 20, marginBottom: 0, color: '#fff', textAlign: 'center', marginTop: 20,},
